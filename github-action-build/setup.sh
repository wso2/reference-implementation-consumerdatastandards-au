...
cp $ARTIFACTS_DIR/wso2is-6.1.0.zip $TEST_HOME
unzip $TEST_HOME/wso2is-6.1.0.zip -d $TEST_HOME

cp $ARTIFACTS_DIR/wso2am-4.2.0.zip $TEST_HOME
...
cp $ARTIFACTS_DIR/wso2-obiam-accelerator-3.0.0.zip $TEST_HOME
unzip $TEST_HOME/wso2-obiam-accelerator-3.0.0.zip -d $TEST_HOME/wso2is-6.1.0

cp $ARTIFACTS_DIR/wso2-obam-accelerator-3.0.0.zip $TEST_HOME
unzip $TEST_HOME/wso2-obam-accelerator-3.0.0.zip -d $TEST_HOME/wso2am-4.2.0

cp $ARTIFACTS_DIR/wso2-obbi-accelerator-3.0.0.zip $TEST_HOME
